                    ...
                    <tbody>
                        @foreach ($records as $key => $item)
                            <tr>
                                ...
                                <td>
                                    <input style="width: 300px" type="text" wire:model="records.{{$key}}.recognition" id="records.{{$key}}.recognition" class="form-control text-uppercase">
                                    <div class="error-field">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <div>
                                            <input type="file" style="width: 300px;" wire:change="setActiveAccordion('skills')" wire:model="records.{{$key}}.documents" id="records.{{$key}}.documents" class="form-control">
                                        </div>
