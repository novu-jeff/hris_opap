                ...
                <tbody>
                    @forelse($records as $record)
                        <tr data-id="{{$record->id}}">
                            <td>{{$record->name}}</td>
                            <td>
                                <a href="{{route('users.access.show', ['user_access' => $record->id])}}" class="btn btn-primary mx-1">
                                    <i class="fa-solid fa-fingerprint"></i>
                                </a>
                                <a href="{{route('users.access.edit', ['user_access' => $record->id])}}" class="btn btn-primary mx-1">
