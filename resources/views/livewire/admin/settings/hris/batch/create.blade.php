            ...
            <div class="card shadow p-4">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            <label class="mb-2" for="fields.batch">Batch ID <span class="text-danger">*</span></label>
                            <input type="text" wire:model="fields.batch" id="fields.batch" class="form-control text-uppercase">
                            <div class="error-field">
                                @error('fields.batch') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                </div>
