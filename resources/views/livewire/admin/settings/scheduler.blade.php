                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-4">
                            ...
                            <div class="error-field">
                                @error('fields.clear_notification') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col-12 col-md-12 mb-4">
                            ...
                            <div class="error-field">
                                @error('fields.change_password') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col-12 col-md-12 mb-4">
                            ...
                            <div class="error-field">
                                @error('fields.reset_leave_credits') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                </div>
