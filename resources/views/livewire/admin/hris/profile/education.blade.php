                ...
                <table class="table table-bordered mt-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" style="width: 800px" wire:model="records.{{$key}}.course" id="records.{{$key}}.course" class="form-control text-uppercase text-center">
                                <div class="error-field">
                                    @error('records.'.$key.'.course') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </td>
                            <td>
                                <input type="number" style="width: 300px" wire:model="records.{{$key}}.from_year" id="records.{{$key}}.from_year" class="form-control text-uppercase text-center" placeholder="ex. 2020">
                                <div class="error-field">
                                    @error('records.'.$key.'.from_year') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </td>
                            <td>
                                <input type="number" style="width: 300px" wire:model="records.{{$key}}.to_year" id="records.{{$key}}.to_year" class="form-control text-uppercase text-center" placeholder="ex. 2024">
                                <div class="error-field">
                                    @error('records.'.$key.'.to_year') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </td>
                            <td>
                                <input type="text" style="width: 300px" wire:model="records.{{$key}}.highest_level" id="records.{{$key}}.highest_level" class="form-control text-uppercase text-center">
                                <div class="error-field">
                                    @error('records.'.$key.'.highest_level') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </td>
                            <td>
                                <input type="number" style="width: 300px" wire:model="records.{{$key}}.year_graduated" id="records.{{$key}}.year_graduated" class="form-control text-uppercase text-center" placeholder="ex. 2024">
                                <div class="error-field">
