...
<div>
    ...
    <div class="col-md-4 d-flex justify-content-start justify-content-md-end">
        <button wire:click="exportExcelEmeRata" class="btn btn-success mt-2 mt-md-0">
            Export to Excel
        </button>
    </div>
   ...
   <div class="row mb-4">
    ...
    <div class="col-md-4">
        ...
        <div class="info-row">
            <span class="info-label">RA Total:</span>
            <span class="info-value">
                PHP {{ number_format($records['totals']['ra'], 2) }}
            </span>
        </div>

        <div class="info-row">
            <span class="info-label">TA Total:</span>
            <span class="info-value">
                PHP {{ number_format($records['totals']['ta'], 2) }}
            </span>
        </div>
    ...
    <table class="table table-bordered table-striped table-hover">
            ...
            @forelse($records['payroll_items'] as $sectionGroup)
                ...
                @foreach($sectionGroup['employees'] as $item)
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            {{ number_format($item['ra'], 2) }}
                        </td>

                        <td class="text-end">
                            {{ number_format($item['ta'], 2) }}
                        </td>
                ...
                @if(isset($sectionGroup['section_totals']))
                    <tr class="fw-bold bg-light">
                        ...
                        <td class="text-end">
                            {{ number_format($sectionGroup['section_totals']['ra'], 2) }}
                        </td>

                        <td class="text-end">
                            {{ number_format($sectionGroup['section_totals']['ta'], 2) }}
                        </td>
            ...
            @empty
                ...
                <tr>
                    <td colspan="7" class="text-center text-muted py-4">
                        No EME RATA payroll data found.
                    </td>
                </tr>
        ...
        <tfoot>
            <tr class="fw-bold bg-dark text-white">
                ...
                <td class="text-end">
                    {{ number_format($records['totals']['ra'], 2) }}
                </td>

                <td class="text-end">
                    {{ number_format($records['totals']['ta'], 2) }}
                </td>
