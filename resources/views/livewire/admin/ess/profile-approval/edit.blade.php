                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.lastname.new" id="lastname" class="form-control restricted {{$records['employee_personal']['lastname']['new'] !== $records['employee_personal']['lastname']['old'] ? 'border-primary border-2' : ''}}">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.firstname.new" id="firstname" class="form-control restricted {{$records['employee_personal']['firstname']['new'] !== $records['employee_personal']['firstname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.middlename.new" id="middlename" class="form-control restricted {{$records['employee_personal']['middlename']['new'] !== $records['employee_personal']['middlename']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-2 mb-3">
                                                    ...
                                                    <select disabled wire:model="records.employee_personal.suffix.new" id="suffix" class="form-select restricted {{$records['employee_personal']['suffix']['new'] !== $records['employee_personal']['suffix']['old'] ? 'border-primary border-2' : ''}}">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" wire:model="records.employee_personal.birthday.new" id="birthday" class="form-control restricted {{$records['employee_personal']['birthday']['new'] !== $records['employee_personal']['birthday']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <select disabled wire:model="records.employee_personal.civil_status.new" id="civil_status" class="form-select restricted {{$records['employee_personal']['civil_status']['new'] !== $records['employee_personal']['civil_status']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <select disabled wire:model="records.employee_personal.sex.new" id="sex" class="form-select restricted {{$records['employee_personal']['sex']['new'] !== $records['employee_personal']['sex']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <select disabled wire:model="records.employee_personal.citizenship.new" wire:change="select_change('citizenship')"  id="citizenship" class="form-select restricted {{$records['employee_personal']['citizenship']['new'] !== $records['employee_personal']['citizenship']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                                ...
                                                @if ($isDualCitizenship)
                                                    <div class="col-12 col-md-4 mb-3">    
                                                        <label class="mb-2" for="country">Country (Dual Citizenship)</label>
                                                            <select disabled wire:model="records.employee_personal.country.new" id="citizenship_type" class="form-select restricted {{$records['employee_personal']['country']['new'] !== $records['employee_personal']['country']['old'] ? 'border-primary border-2' : ''}}">
                                                                <option value=""> - CHOOSE - </option>
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <select disabled wire:model="records.employee_personal.citizenship_type.new" id="citizenship_type" class="form-select restricted {{$records['employee_personal']['citizenship_type']['new'] !== $records['employee_personal']['citizenship_type']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-12 col-md-12 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.present_address.new" id="present_address" class="form-control restricted {{$records['employee_personal']['present_address']['new'] !== $records['employee_personal']['present_address']['old'] ? 'border-primary border-2' : ''}}" placeholder="House / Block / Lot / Street / Subdivision / Village / Barangay">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.present_province.new" id="present_province" class="form-control restricted {{$records['employee_personal']['present_province']['new'] !== $records['employee_personal']['present_province']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.present_city.new" id="present_city" class="form-control restricted {{$records['employee_personal']['present_city']['new'] !== $records['employee_personal']['present_city']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-12 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.permanent_address.new" id="permanent_address" class="form-control restricted {{$records['employee_personal']['permanent_address']['new'] !== $records['employee_personal']['permanent_address']['old'] ? 'border-primary border-2' : ''}}" placeholder="House / Block / Lot / Street / Subdivision / Village / Barangay">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.permanent_province.new" id="permanent_province" class="form-control restricted {{$records['employee_personal']['permanent_province']['new'] !== $records['employee_personal']['permanent_province']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.permanent_city.new" id="permanent_city" class="form-control restricted {{$records['employee_personal']['permanent_city']['new'] !== $records['employee_personal']['permanent_city']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.mobile_number.new" id="mobile_number" class="form-control restricted {{$records['employee_personal']['mobile_number']['new'] !== $records['employee_personal']['mobile_number']['old'] ? 'border-primary border-2' : ''}}" data-mask="mobile">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.tel_no.new" id="tel_no" class="form-control restricted {{$records['employee_personal']['tel_no']['new'] !== $records['employee_personal']['tel_no']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.email.new" id="email" class="form-control restricted text-lowercase {{$records['employee_personal']['email']['new'] !== $records['employee_personal']['email']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.height.new" id="height" class="form-control restricted {{$records['employee_personal']['height']['new'] !== $records['employee_personal']['height']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.weight.new" id="weight" class="form-control restricted {{$records['employee_personal']['weight']['new'] !== $records['employee_personal']['weight']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-6 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_personal.blood_type.new" id="blood_type" class="form-control restricted {{$records['employee_personal']['blood_type']['new'] !== $records['employee_personal']['blood_type']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.spouse_surname.new" id="records.employee_parents.spouse_surname.new" class="form-control restricted {{$records['employee_parents']['spouse_surname']['new'] !== $records['employee_parents']['spouse_surname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.spouse_firstname.new" id="records.employee_parents.spouse_firstname.new" class="form-control restricted {{$records['employee_parents']['spouse_firstname']['new'] !== $records['employee_parents']['spouse_firstname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.spouse_middlename.new" id="records.employee_parents.spouse_middlename.new" class="form-control restricted {{$records['employee_parents']['spouse_middlename']['new'] !== $records['employee_parents']['spouse_middlename']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    <label class="mb-2" for="suffix">Suffix</label>
                                                    <select disabled wire:model="records.employee_parents.spouse_suffix.new" id="records.employee_parents.spouse_suffix.new" class="form-select restricted {{$records['employee_parents']['spouse_suffix']['new'] !== $records['employee_parents']['spouse_suffix']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                                        <option value="jr">Jr</option>
                                                        <option value="sr">Sr</option>
                                                        <option value="I">I</option>
                                                ...
                                                <div class="col-12 col-md-12 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.spouse_occupation.new" id="records.employee_parents.spouse_occupation.new" class="form-control restricted {{$records['employee_parents']['spouse_occupation']['new'] !== $records['employee_parents']['spouse_occupation']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.spouse_contact_no.new" id="records.employee_parents.spouse_contact_no.new" class="form-control restricted {{$records['employee_parents']['spouse_contact_no']['new'] !== $records['employee_parents']['spouse_contact_no']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.father_surname.new" id="records.employee_parents.father_surname.new" class="form-control restricted {{$records['employee_parents']['father_surname']['new'] !== $records['employee_parents']['father_surname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.father_firstname.new" id="records.employee_parents.father_firstname.new" class="form-control restricted {{$records['employee_parents']['father_firstname']['new'] !== $records['employee_parents']['father_firstname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.father_middlename.new" id="records.employee_parents.father_middlename.new" class="form-control restricted {{$records['employee_parents']['father_middlename']['new'] !== $records['employee_parents']['father_middlename']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-3 mb-3">
                                                    <label class="mb-2" for="suffix">Suffix</label>
                                                    <select disabled wire:model="records.employee_parents.father_suffix.new" id="records.employee_parents.father_suffix.new" class="form-select restricted {{$records['employee_parents']['father_suffix']['new'] !== $records['employee_parents']['father_suffix']['old'] ? 'border-primary border-2' : ''}}">
                                                        <option value=""> - CHOOSE - </option>
                                                        <option value="jr">Jr</option>
                                                        <option value="sr">Sr</option>
                                                        <option value="I">I</option>
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.mother_surname.new" id="records.employee_parents.mother_surname.new" class="form-control restricted {{$records['employee_parents']['mother_surname']['new'] !== $records['employee_parents']['mother_surname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.mother_firstname.new" id="records.employee_parents.mother_firstname.new" class="form-control restricted {{$records['employee_parents']['mother_firstname']['new'] !== $records['employee_parents']['mother_firstname']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                ...
                                                <div class="col-12 col-md-4 mb-3">
                                                    ...
                                                    <input type="text" readonly wire:model="records.employee_parents.mother_middlename.new" id="records.employee_parents.mother_middlename.new" class="form-control restricted {{$records['employee_parents']['mother_middlename']['new'] !== $records['employee_parents']['mother_middlename']['old'] ? 'border-primary border-2' : ''}}">
                                                    <div class="error-field">
                                                    ...
                                                    <table class="table table-bordered mt-3">
                                                        ...
                                                        <tbody>
                                                            @foreach ($records['employee_children'] as $key => $item)
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" readonly wire:model="records.employee_children.{{$key}}.firstname.new" id="records.employee_children.{{$key}}.firstname.new" class="form-control restricted {{$records['employee_children'][$key]['firstname']['new'] !== $records['employee_children'][$key]['firstname']['old'] ? 'border-primary border-2' : ''}}">
                                                                        <div class="error-field">
                                                                            @error('records.employee_children.'.$key.'.firstname') <span class="text-danger">{{ $message }}</span> @enderror
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" readonly wire:model="records.employee_children.{{$key}}.middlename.new" id="records.employee_children.{{$key}}.middlename.new" class="form-control restricted {{$records['employee_children'][$key]['middlename']['new'] !== $records['employee_children'][$key]['middlename']['old'] ? 'border-primary border-2' : ''}}">
                                                                        <div class="error-field">
                                                                            @error('records.employee_children.'.$key.'.middlename') <span class="text-danger">{{ $message }}</span> @enderror
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" readonly wire:model="records.employee_children.{{$key}}.lastname.new" id="records.employee_children.{{$key}}.lastname.new" class="form-control restricted {{$records['employee_children'][$key]['lastname']['new'] !== $records['employee_children'][$key]['lastname']['old'] ? 'border-primary border-2' : ''}}">
                                                                        <div class="error-field">
                                                                            @error('records.employee_children.'.$key.'.lastname') <span class="text-danger">{{ $message }}</span> @enderror
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" wire:model="records.employee_children.{{$key}}.birthdate.new" id="records.employee_children.{{$key}}.birthdate.new" class="form-control restricted {{$records['employee_children'][$key]['birthdate']['new'] !== $records['employee_children'][$key]['birthdate']['old'] ? 'border-primary border-2' : ''}}">
                                                                        <div class="error-field">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <select disabled style="width: 300px" wire:model="records.employee_education.{{$key}}.level.new" id="records.employee_education.{{$key}}.level.new" class="form-select restricted {{$records['employee_education'][$key]['level']['new'] !== $records['employee_education'][$key]['level']['old'] ? 'border-primary border-2' : ''}}">
                                                <option value=""> - CHOOSE - </option>
                                        ...
                                        <td>
                                            <input type="text" readonly style="width: 300px" wire:model="records.employee_education.{{$key}}.school_name.new" id="records.employee_education.{{$key}}.school_name.new" class="form-control restricted {{$records['employee_education'][$key]['school_name']['new'] !== $records['employee_education'][$key]['school_name']['old'] ? 'border-primary border-2' : ''}}">
                                            <div class="error-field">
                                                @error('records.employee_education.'.$key.'.school_name.new') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" readonly style="width: 300px" wire:model="records.employee_education.{{$key}}.course.new" id="records.employee_education.{{$key}}.course.new" class="form-control restricted {{$records['employee_education'][$key]['course']['new'] !== $records['employee_education'][$key]['course']['old'] ? 'border-primary border-2' : ''}}">
                                            <div class="error-field">
                                                @error('records.employee_education.'.$key.'.course.new') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" style="width: 300px" wire:model="records.employee_education.{{$key}}.from_year.new" id="records.employee_education.{{$key}}.from_year.new" class="form-control restricted {{$records['employee_education'][$key]['from_year']['new'] !== $records['employee_education'][$key]['from_year']['old'] ? 'border-primary border-2' : ''}}">
                                            <div class="error-field">
                                                @error('records.employee_education.'.$key.'.from_year.new') <span class="text-danger">{{ $message }}</span> @enderror
                                            </div>
                                        </td>
                                        <td>
                                            <input type="text" style="width: 300px" wire:model="records.employee_education.{{$key}}.to_year.new" id="records.employee_education.{{$key}}.to_year.new" class="form-control restricted {{$records['employee_education'][$key]['to_year']['new'] !== $records['employee_education'][$key]['to_year']['old'] ? 'border-primary border-2' : ''}}">
                                            <div class="error-field">
                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    @foreach ($records['employee_civil_service'] as $key => $item)
                                        <tr>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_civil_service.{{$key}}.certification.new" id="records.employee_civil_service.{{$key}}.certification.new" class="form-control restricted {{$records['employee_civil_service'][$key]['certification']['new'] !== $records['employee_civil_service'][$key]['certification']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_civil_service.'.$key.'.certification.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_civil_service.{{$key}}.rating.new" id="records.employee_civil_service.{{$key}}.rating.new" class="form-control restricted {{$records['employee_civil_service'][$key]['rating']['new'] !== $records['employee_civil_service'][$key]['rating']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_civil_service.'.$key.'.rating.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_civil_service.{{$key}}.date_exam.new" id="records.employee_civil_service.{{$key}}.date_exam.new" class="form-control restricted {{$records['employee_civil_service'][$key]['date_exam']['new'] !== $records['employee_civil_service'][$key]['date_exam']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_civil_service.'.$key.'.date_exam.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_civil_service.{{$key}}.place_exam.new" id="records.employee_civil_service.{{$key}}.place_exam.new" class="form-control restricted {{$records['employee_civil_service'][$key]['place_exam']['new'] !== $records['employee_civil_service'][$key]['place_exam']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_civil_service.'.$key.'.place_exam.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>                                         
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_civil_service.{{$key}}.license_no.new" id="records.employee_civil_service.{{$key}}.license_no.new" class="form-control restricted {{$records['employee_civil_service'][$key]['license_no']['new'] !== $records['employee_civil_service'][$key]['license_no']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    @foreach ($records['employee_trainings'] as $key => $item)
                                        <tr>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.type.new" id="records.employee_trainings.{{$key}}.type.new" class="form-control restricted {{$records['employee_trainings'][$key]['type']['new'] !== $records['employee_trainings'][$key]['type']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_trainings.'.$key.'.type.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.name.new" id="records.employee_trainings.{{$key}}.name.new" class="form-control restricted {{$records['employee_trainings'][$key]['name']['new'] !== $records['employee_trainings'][$key]['name']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_trainings.'.$key.'.name.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.date_from.new" id="records.employee_trainings.{{$key}}.date_from.new" class="form-control restricted {{$records['employee_trainings'][$key]['date_from']['new'] !== $records['employee_trainings'][$key]['date_from']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_trainings.'.$key.'.date_from.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.date_to.new" id="records.employee_trainings.{{$key}}.date_to.new" class="form-control restricted {{$records['employee_trainings'][$key]['date_to']['new'] !== $records['employee_trainings'][$key]['date_to']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_trainings.'.$key.'.date_to.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>  
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.consumed_hours.new" id="records.employee_trainings.{{$key}}.consumed_hours.new" class="form-control restricted {{$records['employee_trainings'][$key]['consumed_hours']['new'] !== $records['employee_trainings'][$key]['consumed_hours']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_trainings.'.$key.'.consumed_hours.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>                                         
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_trainings.{{$key}}.sponsored_by.new" id="records.employee_trainings.{{$key}}.sponsored_by.new" class="form-control restricted {{$records['employee_trainings'][$key]['sponsored_by']['new'] !== $records['employee_trainings'][$key]['sponsored_by']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                            ...
                            <table class="table table-bordered mt-3">
                                ...
                                <tbody>
                                    @foreach ($records['employee_others'] as $key => $item)
                                        <tr>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.organization.new" id="records.employee_others.{{$key}}.organization.new" class="form-control restricted {{$records['employee_others'][$key]['organization']['new'] !== $records['employee_others'][$key]['organization']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_others.'.$key.'.organization.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.address.new" id="records.employee_others.{{$key}}.address.new" class="form-control restricted {{$records['employee_others'][$key]['address']['new'] !== $records['employee_others'][$key]['address']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_others.'.$key.'.address.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.date_from.new" id="records.employee_others.{{$key}}.date_from.new" class="form-control restricted {{$records['employee_others'][$key]['date_from']['new'] !== $records['employee_others'][$key]['date_from']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_others.'.$key.'.date_from.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.date_to.new" id="records.employee_others.{{$key}}.date_to.new" class="form-control restricted {{$records['employee_others'][$key]['date_to']['new'] !== $records['employee_others'][$key]['date_to']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_others.'.$key.'.date_to.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>  
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.consumed_hours.new" id="records.employee_others.{{$key}}.consumed_hours.new" class="form-control restricted {{$records['employee_others'][$key]['consumed_hours']['new'] !== $records['employee_others'][$key]['consumed_hours']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_others.'.$key.'.consumed_hours.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>                                         
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_others.{{$key}}.position.new" id="records.employee_others.{{$key}}.position.new" class="form-control restricted {{$records['employee_others'][$key]['position']['new'] !== $records['employee_others'][$key]['position']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                            ...
                            <table class="table table-bordered mt-3 w-100">
                                ...
                                <tbody>
                                    @foreach ($records['employee_skills'] as $key => $item)
                                        <tr>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_skills.{{$key}}.name.new" id="records.employee_skills.{{$key}}.name.new" class="form-control restricted {{$records['employee_skills'][$key]['name']['new'] !== $records['employee_skills'][$key]['name']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_skills.'.$key.'.name.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_skills.{{$key}}.recognition.new" id="records.employee_skills.{{$key}}.recognition.new" class="form-control restricted {{$records['employee_skills'][$key]['recognition']['new'] !== $records['employee_skills'][$key]['recognition']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
                                                    @error('records.employee_skills.'.$key.'.recognition.new') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </td>
                                            <td>
                                                <input style="width: 300px" type="text" wire:model="records.employee_skills.{{$key}}.organization.new" id="records.employee_skills.{{$key}}.organization.new" class="form-control restricted {{$records['employee_skills'][$key]['organization']['new'] !== $records['employee_skills'][$key]['organization']['old'] ? 'border-primary border-2' : ''}}">
                                                <div class="error-field">
