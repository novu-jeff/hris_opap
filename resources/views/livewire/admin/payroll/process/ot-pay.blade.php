<div>
    ...
    <div class="row">
        <div class="col-12 col-md-6">
            ...
            <div class="text-uppercase fw-bold">
                Overtime Period : <span class="ms-2">{{$records['payroll']['formatted_ot_period']}}</span>
            </div>
            <div class="text-uppercase fw-bold">
        ...
        <div class="col-12 col-md-6">
            <div class="text-uppercase fw-bold">
                Net Amount : <span class="ms-2">PHP {{number_format($records['payroll']['total_amount'], 2)}}</span>
            </div>
            <div class="text-uppercase fw-bold">
                Tax : <span class="ms-2">PHP {{number_format($records['payroll']['total_tax'], 2)}}</span>
            </div>
            <div class="text-uppercase fw-bold">
                Salary Amount : <span class="ms-2">PHP {{number_format($records['payroll']['total_net_amount'], 2)}}</span>
            </div>
        </div>
    </div>
    <hr class="pt-3">
        ...
        <div class="table-responsive pb-3">
            <table>
                <thead>
                    <tr>
                        <th rowspan="2">No.</th>
                        <th rowspan="2" class="text-center">Employee No.</th>
                        <th rowspan="2" class="text-center">Name</th>
                        <th rowspan="2" class="text-center">Position</th>
                        <th rowspan="2" class="text-center">Basic Salary</th>
                        <th rowspan="2" class="text-center">No. Of Hours / Minutes</th>
