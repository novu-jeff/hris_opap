...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body">
        ...
        <h5 class="fw-bold mb-3">
            Add Employee to Semester Premium Payroll
        </h5>
                        ...
                        @forelse($records['payroll_items'] as $sectionIndex => $sectionGroup)
                            ...
                            @foreach($sectionGroup['employees'] as $employeeIndex => $record)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        <input
                                            type="text"
                                            wire:model="january_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        ...
                                        <input
                                            type="text"
                                            wire:model="february_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end"
                                        >
                                    </td>
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        <input
                                            type="text"
                                            wire:model="march_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end"
                                        >
                                    </td>
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        <input
                                            type="text"
                                            wire:model="april_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end"
                                        >
                                    </td>
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        <input
                                            type="text"
                                            wire:model="may_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end"
                                        >
                                    </td>
                                    ...
                                    <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                        <input
                                            type="text"
                                            wire:model="june_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end"
                                        >
                                    </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="july_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="august_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="september_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="october_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="november_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                                ...
                                <td class="text-end fw-bold text-primary" style="min-width: 120px;">
                                    <input
                                        type="text"
                                        wire:model="december_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                        wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                        class="form-control text-end"
                                    >
                                </td>
                            ...
                            @endif
                                    ...
                                    <td class="text-end fw-bold text-primary">
                                        ...
                                        <input
                                            type="text"
                                            wire:model="total_amount.{{ $sectionIndex }}.{{ $employeeIndex }}"
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                    ...
                                    <td>
                                        ...
                                        <input
                                            ...
                                            wire:change="recompute({{ $sectionIndex }}, {{ $employeeIndex }})"
                                            class="form-control text-end fw-bold {{ $isApproved ? 'restricted' : '' }}"
                                            {{ $isApproved ? 'readonly' : '' }}
                                        >
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="100%" class="text-center py-5 text-muted fw-bold">
                                    ...
                                    NO PREMIUM PAYROLL RECORDS FOUND
