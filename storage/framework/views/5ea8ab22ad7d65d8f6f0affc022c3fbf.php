...
<link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick-theme.css"/>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/sass/app.scss', 'resources/js/app.js', 'resources/sass/home-layout.scss', 'resources/sass/employee-layout.scss', 'resources/sass/chat.scss']); ?>
...
[$__name, $__params] = $__split('employee.new-employee');

$__html = app('livewire')->mount($__name, $__params, 'lw-1676142167-0', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('employee.account-status');

$__html = app('livewire')->mount($__name, $__params, 'lw-1676142167-1', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <?php echo $__env->make('components.employee.navbarnew', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <!-- FLOATING CLOCK-IN/OUT BUTTON -->
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['read clock-in-out', 'write clock-in-out'])): ?>
        <div id="floatingClockBtn">
            <a href="<?php echo e(route('employee.clock')); ?>" class="btn btn-success">
        ...
        <?php endif; ?>
          ...
          <!-- ================= SIDEBAR ================= -->
        <?php echo $__env->make('components.employee.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- create a separate sidebar Blade -->
        <main>
            <div class="container">
                <div class="content">
...
[$__name, $__params] = $__split('employee.unseen-messages-badge');

$__html = app('livewire')->mount($__name, $__params, 'lw-1676142167-2', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('employee.request-status');

$__html = app('livewire')->mount($__name, $__params, 'lw-1676142167-3', $__slots ?? [], get_defined_vars());
...
Livewire.onError(statusCode => {
    if (statusCode === 419) {
        window.location.href = "<?php echo e(route('session.expired')); ?>";
        return false;
    }
});
...
</html> <?php /**PATH /var/www/html/oppapru_hris/resources/views/layouts/employee.blade.php ENDPATH**/ ?>