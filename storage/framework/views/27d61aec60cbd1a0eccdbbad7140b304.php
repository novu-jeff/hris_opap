                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('employment-type.edit', ['employment_type' => $record->id])); ?>" class="btn btn-primary mx-1">
...
</div><?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/admin/settings/hris/employment-type/index.blade.php ENDPATH**/ ?>