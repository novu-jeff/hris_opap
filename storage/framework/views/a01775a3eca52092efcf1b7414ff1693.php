                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <div class="error-field">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['records.profile'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(isset($records['profile']) && is_string($records['profile'])): ?>
                                <img src="<?php echo e(asset('storage/' . $records['profile'])); ?>" alt="Profile Photo" class="mt-2" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;">
                            <?php elseif($records['profile'] instanceof \Livewire\TemporaryUploadedFile): ?>
                                <img src="<?php echo e($records['profile']->temporaryUrl()); ?>" alt="Profile Preview" class="mt-2" style="width: 100px; height: 100px; object-fit: cover; border-radius: 50%;">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="col-12 col-md-4 mb-3">
                            ...
                            <div class="error-field">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['birth_certificate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-danger"><?php echo e($message); ?></span> <?php unset($message);
...
<?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/employee/profile/personal.blade.php ENDPATH**/ ?>