...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/sass/app.scss', 'resources/js/app.js', 'resources/sass/admin-layout.scss', 'resources/sass/chat.scss']); ?>
       <style>
        .chat-float-btn {
            position: fixed;
            bottom: 25px;
...
<body>
    ...
    <div id="admin-app">
       ...
       <?php echo $__env->make('components.admin.sidebar-desk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <main>
            <div class="container">
        ...
        <div class="footer mt-5 py-4">
            <div class="container d-flex justify-content-center">
                <div class="text-center">
                    ...
                    <p class="text-uppercase fw-bold mb-0 mt-3">Powered by <?php echo e($provider['company']); ?></p>
                    <hr class="my-2" style="width: 100%;">
                    <p class="text-uppercase text-muted fw-bold" style="font-size: 13px;"><?php echo e($provider['tagline']); ?></p>
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH /var/www/html/oppapru_hris/resources/views/layouts/admin.blade.php ENDPATH**/ ?>