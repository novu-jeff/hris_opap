                        ...
                        <tr data-id="<?php echo e($record->id); ?>">
                            ...
                            <td>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($record->status == 'pending'): ?>
                                    <a href="<?php echo e(route('employee.time-adjustments.edit', ['id' => $record->id])); ?>" class="btn btn-primary mx-1">
...
</div><?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/employee/time-adjustments/index.blade.php ENDPATH**/ ?>