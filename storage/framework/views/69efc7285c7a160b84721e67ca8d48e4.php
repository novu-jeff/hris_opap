                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr data-id="<?php echo e($record->id); ?>">
                            ...
                            <td class="d-flex justify-content-start">
                               <a href="<?php echo e(route('deductions.index', ['id' => $record->id])); ?>" class="btn btn-secondary mx-1">
                                    <i class="fa-solid fa-plus text-white"></i>
                                </a>
                                <a href="<?php echo e(route('other-deductions.edit', ['other_deduction' => $record->id])); ?>" class="btn btn-primary mx-1">
...
</div><?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/admin/settings/hris/deductions/index.blade.php ENDPATH**/ ?>