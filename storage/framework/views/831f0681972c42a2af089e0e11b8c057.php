<div class="dtr">
    ...
    <div class="dtr-header ms-5 d-flex justify-content-center gap-4">
        ...
        <div>
            ...
            <h1>For the month of <div class="underline" style="min-width: auto !important; padding: 0 15px 0 15px !important; text-transform: uppercase"><?php echo e(\Carbon\Carbon::parse($dtrDate)->format('F Y')); ?> </div>(FY)</h1>
        </div>
    </div>

    <div class="dtr-info">
        <div>Employee Name: <div  style="margin-left: 10px;" class="underline"><?php echo e($logs['employee_account']['firstname'] . ' ' . $logs['employee_account']['middlename'] . ' ' . $logs['employee_account']['lastname']); ?></div></div>
        <div>Position: <div  style="margin-left: 10px;" class="underline"><?php echo e($logs['employee_account']['position']); ?></div></div>
        <div>Official Time: <div style="margin-left: 10px; text-transform: capitalize;" class="underline"><?php echo e($officialTime['shift_duration'] ?? 'flexible'); ?></div></div>
        <div>Office/Department: <div style="margin-left: 10px;" class="underline"><?php echo e($logs['employee_account']['section']); ?></div></div>
    </div>
...
</div><?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/admin/reports/daily-time-record/employee/dtr-table.blade.php ENDPATH**/ ?>