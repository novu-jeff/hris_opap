                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr data-id="<?php echo e($record->id); ?>">
                            ...
                            <td><?php echo e($record->purpose); ?></td>
                            <td><?php echo e(format_date($record->from, 'date_string') . ' - ' . format_date($record->to, 'date_string')); ?></td>
                            <td>
                                <?php echo status_alert($record->status); ?>    
                            </td>  
                            <td>
                                <!--[if BLOCK]><![endif]--><?php if($record->status == 'cancelled'): ?>
                                     <button wire:click="remove(true, <?php echo e($record->id); ?>)" class="btn btn-danger mx-1" title="Delete Officcial Business">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <!--[if BLOCK]><![endif]--><?php if($record->status == 'pending'): ?>
                                    <a href="<?php echo e(route('employee.obs.edit', ['id' => $record->id])); ?>" class="btn btn-primary mx-1" title="Edit Official Business">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>
                                    <a href="javascript:void(0)" wire:click="download(<?php echo e($record->id); ?>)" class="btn btn-primary mx-1" title="Download Official Business">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($record->status == 'granted'): ?>
                                    ...
                                    <button wire:click="remove(true, <?php echo e($record->id); ?>)" class="btn btn-danger mx-1" title="Delete Official Business">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/employee/business-slip/index.blade.php ENDPATH**/ ?>