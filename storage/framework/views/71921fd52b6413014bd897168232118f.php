...
<div class="mahcon">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mt-5 mb-4">
            <div class="section-title">
                <h1>Daily Time Record <span  class="text-primary"><?php echo e($employee_no); ?></span></h1>
            </div>
           
        </div>
        <div class="mt-3">
            <!--[if BLOCK]><![endif]--><?php if($logs): ?>
                    ...
                    <div class="d-flex gap-3">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mx-3" id="monthYear">
                                <?php echo e(\Carbon\Carbon::parse($dtrDate)->format('F, Y')); ?>
                            ...
                            <button 
                                ...
                                wire:loading.attr="disabled" 
                                wire:loading.class="btn-secondary"
                                <?php if($dtrDate == now()->format('F, Y')): echo 'disabled'; endif; ?>>
    ...
    <div class="container">
        <!--[if BLOCK]><![endif]--><?php if($logs): ?>
            <!--[if BLOCK]><![endif]--><?php if(!$hasLeaveCard && config('app.product') === 'government'): ?>
                <div class="warning mt-5 mb-3">
                    <div class="alert alert-info fw-bold text-center" role="alert">
                        ...
                        <small class="text-uppercase" style="font-size: 12px;">
                            <a href="<?php echo e(route('leave.show', ['leave' => 1, 'employee' => $employee_no])); ?>">Click here to add</a>
                        </small>
                    </div>
                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            <div class="print-container mt-4 ssss">
                 <?php
                    $isAdmin = false;
                ?>
                <?php echo $__env->make('livewire.admin.reports.daily-time-record.employee.dtr-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        <?php else: ?>
            <div class="alert alert-danger" role="alert">
                <!--[if BLOCK]><![endif]--><?php if(!empty($errors)): ?>
                    <ul class="m-0">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $errors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="text-uppercase"><?php echo e($error); ?></li>
      ...
      <div id="print-section" class="print-wrapper print-area-hidden">
         <!--[if BLOCK]><![endif]--><?php if($logs): ?>
        <?php echo $__env->make('livewire.admin.reports.daily-time-record.employee.print-dtr-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         <?php else: ?>
            <div class="alert alert-danger" role="alert">
                <!--[if BLOCK]><![endif]--><?php if(!empty($errors)): ?>
                    <ul class="m-0">
...
<?php /**PATH /var/www/html/oppapru_hris/resources/views/livewire/admin/reports/daily-time-record/employee/show.blade.php ENDPATH**/ ?>