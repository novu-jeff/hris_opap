...
[$__name, $__params] = $__split('employee.daily-time-record', [
            'month' => $month,
            'year' => $year,
        ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2295071039-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.employee', [
    'title' => $title
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/oppapru_hris/resources/views/employee/daily-time-record.blade.php ENDPATH**/ ?>