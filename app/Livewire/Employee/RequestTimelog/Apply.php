...
use App\Models\EmployeeRequestLogAttachments;
...
class Apply extends Component
{
    ...
    public function loadRecords() {
        ...
        if(!is_null($this->record_id)) {
            $records = EmployeeRequestLog::where('id', $this->record_id)
    ...
    {
        $record = EmployeeRequestLogAttachments::find($id);
    ...
    public function save(bool $isNotify = true) {
        ...
        if ($isNotify) {
            ...
            try {
                ...
                $model = EmployeeRequestLog::updateOrCreate([
                    'id' => $this->record_id,
                ], [
                ...
                foreach ($this->attachments as $attachment) {
                    ...
                    $existingAttachment = EmployeeRequestLogAttachments::where('employee_requests_id', $model->id)->first();
                    if ($existingAttachment && $existingAttachment->file) {
                        Storage::disk('public')->delete('request-timelogs/' . $existingAttachment->file);
                    }

                    EmployeeRequestLogAttachments::updateOrCreate([
                ...
                if (is_null($this->record_id)) {
                    ...
                    return $this->dispatch('alert', [
                        ...
                        'redirect' => route('employee.request-timelog.edit', ['id' => $this->record_id])
                    ]);
                }
            } catch (\Exception $e) {
                return $this->dispatch('alert', [
    ...
    {
        return view('livewire.employee.request-timelog.apply');
    }
}
