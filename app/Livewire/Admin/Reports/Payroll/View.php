...
foreach ($sections as $sectionName => $employees) {
    ...
    $sectionTotals = [
        ...
        'tax_1' => $employees->sum('tax_1'),
        'tax_5' => $employees->sum('tax_5'),
        'tax_6' => $employees->sum('tax_6'),
        'tax_11' => $employees->sum('tax_11'),
    ...
    $totals = [
        ...
        'tax_1' => $items->sum('tax_1'),
        'tax_5' => $items->sum('tax_5'),
        'tax_6' => $items->sum('tax_6'),
        'tax_11' => $items->sum('tax_11'),
        'uca' => $items->sum('uca'),
