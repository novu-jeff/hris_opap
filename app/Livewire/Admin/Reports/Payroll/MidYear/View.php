...
namespace App\Livewire\Admin\Reports\Payroll\MidYear;
        ...
        */
        ...
        foreach ($sections as $sectionName => $employees) {
            ...
            $sectionTotals = [
                ...
                'bonus' => $employees->sum('bonus'),
                'tax' => $employees->sum('tax'),
...
public function exportExcel()
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.reports.payroll.mid-year.view', [
