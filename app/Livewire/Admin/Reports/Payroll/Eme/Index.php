...
class Index extends Component
{
    ...
    {
        $payroll = PayrollEme::findOrFail($id);
    ...
    public function render()
{
    ...
    $query = PayrollEme::withCount('items')
    ...
    return view('livewire.admin.reports.payroll.eme.index', [
