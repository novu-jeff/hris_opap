...
use App\Exports\PayrollExportGratuity;
...
class View extends Component
{
    ...
    public PayrollGratuity $payroll;
    public $payrollId;
    ...
    {
        $this->payroll = PayrollGratuity::with([
    ...
    protected function prepareRecords()
{
    ...
    */
    ...
    $employmentTypes = $items
        ...
        ->map(fn($item) =>
            $item->information?->employment_type?->name
        )
    ...
    $employmentTypesId = $items

        ->map(fn($item) =>
            $item->information?->employment_type?->id
        )
    ...
    */
    ...
    $sections = $items->groupBy(function ($item) {
        ...
        return $item->information?->section?->name
            ?? 'NO SECTION';
    ...
    */
    ...
    $this->records = [
        ...
        'payroll' => [
            ...
            'formatted_employment_type' =>
                ...
                $employmentTypes->implode(', '),

            'condition_employment_type' =>

                $employmentTypesId->implode(','),
    ...
    public function exportExcelGratuity()
{
...
public function exportExcel()
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.reports.payroll.gratuity.view', [
