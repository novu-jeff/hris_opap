...
class EmeRata extends Component
{
    ...
    public function regeneratePayroll($payroll_id) {
       ...
       // dd('here');
        ...
        \DB::table('payroll_eme_rata_items')
...
//dd($employees);
   ...
   \Log::channel('payroll')->info('Payroll batch prepared', [
    ...
    public function deletePayroll($payroll_id) {
        $payroll = PayrollEmeRata::find($payroll_id);
    ...
    public function render()
    {
        ...
        $records = PayrollEmeRata::where('employment_type', $employment_type_id)
        ...
        return view('livewire.admin.payroll.reports.eme-rata', [
            'salary' => $records,
