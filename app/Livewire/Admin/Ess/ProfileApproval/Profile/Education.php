...
class Education extends Component
{
    ...
    {
        $updated = EmployeeUpdateEducation::where('employee_no', $this->employee_no)->get();
        $stored = EmployeeEducation::where('employee_no', $this->employee_no)->get();
    ...
    protected function formatRecords($data) {
        return [
            ...
            'highest_level' => $data['highest_level'] ?? null,
            'year_graduated' => $data['year_graduated'] ?? null,
            'scholarship_honors' => $data['scholarship_honors'] ?? null,
        ];
    }
    ...
    {
        return view('livewire.admin.ess.profile-approval.profile.education');
    }
}
