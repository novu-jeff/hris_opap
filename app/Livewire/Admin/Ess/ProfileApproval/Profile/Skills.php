...
class Skills extends Component
{
    ...
    {
        $updated = EmployeeUpdateSkillsHobbies::where('employee_no', $this->employee_no)->get();
        $stored = EmployeeSkillsHobbies::where('employee_no', $this->employee_no)->get();
    ...
    {
        return view('livewire.admin.ess.profile-approval.profile.skills');
    }
}
