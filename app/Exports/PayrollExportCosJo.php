    ...
    public function collection()
{
    ...
    $headers = [
        ...
        'MPL','MP2','MPL STLMS','CIR375, CIR449',
        'Overpay', 'Tax1%', 'Tax5%', 'Tax6%', 'Tax11%','UCA','AUT','TOTAL DED','NET AMOUNT','DBP BRANCH',
    ...
    foreach ($groupedByDepartment as $department => $departmentEmployees) {
     ...
     $rows->push([
        ...
        $departmentEmployees->sum('tax_1'),
        $departmentEmployees->sum('tax_5'),
        $departmentEmployees->sum('tax_6'),
        $departmentEmployees->sum('tax_11'),
