...
Route::prefix('admin')->group(function() {
    ...
    Route::middleware(['auth'])->group(function() {
        ...
        Route::prefix('reports')->group( function() {
            ...
            Route::get('payroll-record', [PayrollReportController::class, 'index'])
                ->middleware('permission:read payroll-report')
                ->name('reports.payroll');
            Route::get('payroll-record/view/{payroll}', [PayrollReportController::class, 'view'])
                ->middleware('permission:read payroll-report')
                ->name('reports.payroll.view');
